...
CREATE TABLE `users` (
  ...
  `role` enum('user','provider') DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `role`, `username`, `phone`, `location`, `profile_pic`, `created_at`) VALUES
(1, 'sourabh', 'harry123@gmail.com', '$2y$10$D2dt.Roha8ZdMRvTRbi6oujhIkhU2dK4XIbnt5sIpWJNigmj9h8B6', 'provider', '@sourabh7696', '7697087818', 'verka amritsar', '1776072888_cosmic shadow krishna.jpg', '2026-04-13 09:34:48');
...
INSERT INTO `videos` (`id`, `user_id`, `video_path`, `caption`, `type`, `created_at`) VALUES
(1, 1, '1776074970__DSC3451.JPG', 'enjoying cousin\'s marriage', 'image', '2026-04-13 10:09:30');
